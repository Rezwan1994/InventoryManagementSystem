...
$(document).ready(function () {
    ...
    $('#UploadedFile').fileupload({
        ...
        add: function (e, data) {
            ...
            if (ext[1] == 'PNG' ||  ext[1] == 'doc' || ext[1] == 'docx' || ext[1] == 'xls' || ext[1] == 'xlsx' || ext[1] == 'jpeg' || ext[1] == 'jpg' || ext[1] == 'gif' || ext[1] == 'png' || ext[1] == 'rtf' || ext[1] == 'pdf' || ext[1] == 'txt' || ext[1] == 'mp4' || ext[1] == 'mov') {
